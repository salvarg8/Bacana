...
public class DataManager : System.IDisposable
{
    ...
    public DataTable ConsultarTabla2(string tabla)
    {
        return this.ConsultaSQL("Select * from " + tabla + " ORDER BY nombre");
    }

    public DataTable ConsultarTablaParam(string tabla, string col, string col2, int param)
    {
        return this.ConsultaSQL("Select " + col + " from " + tabla + " where " + col2 + " = " + param);
    }
}